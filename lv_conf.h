...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  <emscripten.h>         /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR ((uint32_t)emscripten_get_now())     /*Expression evaluating to current systime in ms*/
